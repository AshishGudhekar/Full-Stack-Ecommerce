...
public class CartServiceImpl implements CartService {
    ...
    public CartDTO getCart(String emailId, Long cartId) {
        ...
        CartDTO cartDTO = modelmapper.map(cart, CartDTO.class);
        // to get quantity of product in cart
    ...
    public void updateProductInCarts(Long cartId, Long productId) {
        ...
        //let assume in product details changes like price discount .... etc
        //so that should be reflect in Cart so logic is below
        // here will get current cartPrice before updating product
